...
function Sedes() {
  ...
  const handleSave = () => {
    ...
    api
      ...
      .then((response) => {
        ...
        Swal.fire("Éxitosamente", "Sede ha sido guardada.", "success");
      })
      .catch((error) => {
        ...
        Swal.fire(
          "Error!",
          "Ha habido un error al guardar la sede, revisa la información digitada!.",
          "error"
        );
      })
      .catch((error) => {
  ...
  const handleUpdate = () => {
    ...
    api
      .put(`Sedes?Id=${editingSede.idSede}`, updatedSede)
      .then((response) => {
        console.log(response);
        api.put(`Direccions?Id=${editingSede.direccionId}`, direccion).then((response) => {
          console.log(response);
          Swal.fire({
            title: "¡Actualizado!",
            text: `La Sede ${editingSede.idSede} ha sido actualizada correctamente.`,
            icon: "success",
    ...
    const updateDireccionPromise = api.put(`Direccions`, direccion);
